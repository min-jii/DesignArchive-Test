  ...
  $('.message').children('p').text('ITS').delay(600).fadeOut(300, function() {
    $(this).text('Image-2-Text').show().delay(500).fadeOut(300, function() {
      $(this).text('Text-2-Sound').show().delay(500).fadeOut(300, function() {
  	    $(this).text('Sensory Converting').show().delay(500).fadeOut(300, function() {
            $(this).text('based on').show().delay(500).fadeOut(300, function() {
            	$(this).text('Descriptive Alt Text').show().delay(1000).fadeOut(600, function() {
